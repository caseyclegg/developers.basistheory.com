...
You can fully customize your card token, such as the alias, mask, and metadata by leveraging all of our [token capabilities](/docs/concepts/what-are-tokens#what-are-the-capabilities-of-a-token) using [Expressions](/docs/expressions).
